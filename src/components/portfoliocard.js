        ...
        <div>
            ...
            <div className="portfolio-items">
                <div className="day-planner">
                    ...
                    <a href="https://github.com/dcastelline/Day-Planner">GitHub Repository</a>
                </div>
                <div className="note-taker">
                    ...
                    <a href="https://github.com/dcastelline/Note-Taker">GitHub Repository</a>
                </div>
                <div className="password-generator">
                    ...
                    <a href="https://github.com/dcastelline/Homework-3-JSPasswordGenerator">GitHub Repository</a>
                </div>
                ...
                <div className="rescue-spot">
                    ...
                    <a href="https://github.com/dcastelline/Project-1-Rescue-Spot">GitHub Repository</a>
                </div>
                <div className="team-profile">
                    ...
                    <a href="https://github.com/dcastelline/Team-Profile-Generator">GitHub Repository</a>
                </div>
            </div>
        </div>
    )
